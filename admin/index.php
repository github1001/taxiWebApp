...
<div id="cl-wrapper">
  ...
  <div class="cl-sidebar">
    ...
    <div class="cl-navblock">
      <div class="menu-space">
        <div class="content">
          <div class="side-user">
            <div class="avatar"><span style="font-family: 'Dosis', sans-serif; font-size:30px"><center>DASHBOARD</center>
            <?php $db->getMemID();	
					?>
            </span></div>
          ...
          <ul class="cl-vnavigation">
            ...
            <li><a href="add_customer.php" target="loader"><span>Add New Customer</span></a></li>
           <li><a href="all_customer.php" target="loader"><span>View Registered Customers</span></a></li>
			<li><a href="all_drivers.php" target="loader"><span>View Registered Drivers</span></a></li>
			<li><a href="tracker.php" target="loader"><span>Track Members</span></a></li>
            
            <li><a href="all_offer.php" target="loader"><span>Display All Rides</span></a></li>
            

             <li><a href="add_booking.php" target="loader"><span>Booking</span></a></li>
            
            <li><a href="job_list.php" target="loader"><span>Job List</span></a></li>
             <li><a href="chat_box.php" target="loader"><span>Chat Box</span></a></li>        
             <li><a href="add_group.php" target="loader"><span>Create Group</span></a></li>        
  ...
  <div id="head-nav" class="navbar navbar-default">
    ...
    <!--  <ul class="nav navbar-nav navbar-left user-nav"> <center>
        <h1>             TAXI CENTRAL</h1></center></ul>-->
    ...
    <iframe width="100%" frameborder="0" src="add_customer.php" style="overflow: hidden; height: 100%;
        width: 100%; position: absolute;" name="loader">
...
//checking if not assigned set to zero
		...
		$.ajax({
		        ...
		        success: function( json ) {
	        		$.each(json, function(i, value) {
	                		if (value.count != "0") alert("Please find group changed");
		        	});	
		        }
		});
		setTimeout(changegroup, 60000);
	}
	setTimeout(changegroup, 10000);
...
$(document).ready(function(){
	...
	function checkRequestStatues() {
		...
		$.ajax({
		        ...
		        success: function( json ) {
	        		$.each(json, function(i, value) {
	                		if (value.count != "0") alert("Please find and check customer is not assigned last 5 minutes.");
		        	});	
		        }
		});
		setTimeout(checkRequestStatues, 60000);
	}
	setTimeout(checkRequestStatues, 10000);

    });



//Checking and sending sms to driver
$(document).ready(function(){

  function informDriverStatus() {
      var today = new Date();
      var dd = today.getDate();
      var mm = today.getMonth() + 1; //January is 0!
      var yyyy = today.getFullYear();
    ...
    setTimeout(informDriverStatus, 60000);
  }
  setTimeout(informDriverStatus, 10000);
...
//Checking and sending sms to user
$(document).ready(function(){
  ...
  function informuserStatus() {
    ...
    setTimeout(informuserStatus, 60000);
  }
  setTimeout(informuserStatus, 10000);
