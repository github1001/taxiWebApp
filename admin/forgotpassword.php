...
<div id="cl-wrapper" class="login-container">
	...
	<div class="middle-login">
		<div class="block-flat">
			...
			<div>
				<form style="margin-bottom: 0px !important;" class="form-horizontal" action="mail.php" method="post">
					<div class="content">
...
<!--						<button class="btn btn-default" data-dismiss="modal" type="button">Register</button>-->
						<center><button class="btn btn-primary" data-dismiss="modal" name="submit" type="submit">Enter</button></center>
