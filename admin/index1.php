  ...
  <div class="cl-sidebar">
    ...
    <div class="cl-navblock">
      <div class="menu-space">
        <div class="content">
          <div class="side-user">
            <div class="avatar"><span style="font-family: 'Dosis', sans-serif; font-size:30px"><center>TAXI CYCLONE</center>
            <?php $db->getMemID();	
					?>
            </span></div>
          ...
          <ul class="cl-vnavigation">
            ...
            <li><a href="add_customer.php" target="loader"><span>Add New Driver / Vehicle</span></a></li>
			...
			<li><a href="tracker.php" target="loader"><span>Track Drivers</span></a></li>
            <!--
